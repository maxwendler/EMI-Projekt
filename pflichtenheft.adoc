...
. *Sortierfunktionen für die Kataloge*
.. nach Name
.. nach Preis
.. nach Hinzufügungsdatum
.. Veranstaltungen:
... nach Ablaufdatum des Angebots
... nach Bewertung
... nach Dauer

. *Suchfunktion nach Name für Veranstaltungskatalog*

. *Filterfunktion für Veranstaltungskatalog*
.. nach Veranstaltungstyp
... Workshops mehrtägig, Workshops eintägig, Shows
.. nach Talent des Anbieters (nur Workshops)

. *Kommentar- und Bewertungsfunktion für Artikel*

. *Einstellung der Empfehlungsfunktion, zusätzliche Optionen:*
.. neue Veranstaltungen
.. manuell ausgewählte Veranstaltungen

. *Aspektweise (Verpflegung, …) Verstellbarkeit der Aufwandspauschale*
